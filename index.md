...
**GSOD Data have been discontinued by NCEI as of 2025-08-29.** The data
are no longer being updated, and this package will no longer receive any
updates.

For a replacement to access NOAA data, I suggest having a look at
{[noaa](https://github.com/rOpenGov/noaa/)\]}.
...
Or if you use R-Universe, you can install the latest version of {GSODR}
with:
...
[rOpenSci](https://docs.ropensci.org/riem/) allows getting weather data
...
from Australian data sources. Data are sourced from the Western
...
- Please [report any issues or
  bugs](https://codeberg.org/ropensci/GSODR/issues).
